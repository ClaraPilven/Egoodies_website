...
<br>
<div class="container">
    <a class="nav-link primary-btn" href="<?php echo(base_url());?>index.php/Accueil/voir_commandes/">Retour</a>
    ...
    <center>
        ...
        $date = date_create($commande[0]["COMMANDE_date"]);
            ...
            <a href="<?php echo base_url();?>index.php/Accueil/modifier_etat_commande/<?php echo $commande[0]["COMMANDE_id"];?>">Modifier Etat</a>
        </ul>
    </center>
    <table class="table">
        <thead>
