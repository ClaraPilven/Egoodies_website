...
&nbsp;&nbsp;&nbsp;
    A propos du point retrait <strong>
        <?php echo $commandes[0]['POINT_RETRAIT_nom'] ?></strong>, à l'adresse : <strong>
        <?php echo $commandes[0]['POINT_RETRAIT_adresse'] ?></strong> :
...
foreach($commandes as $unproduit) {
    ...
    if ($commande_code != $unproduit["COMMANDE_code"]){
        $commande_code = $unproduit["COMMANDE_code"];
            ...
            <p>Ce point de vente n'a pas de commande en cours actuellement</p> <?php } ?>
        </div>
