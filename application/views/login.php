		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="<?php echo(base_url());?>index.php"><img src="<?php echo(base_url());?>img/logo.png" alt=""></a>
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item"><a class="nav-link" href="<?php echo(base_url());?>single-blog.php">Blog Details</a></li>
								</ul>
							</li>
							<li class="nav-item submenu dropdown active">
								...
								<ul class="dropdown-menu">
									<li class="nav-item active"><a class="nav-link" href="<?php echo(base_url());?>login.php">Login</a></li>
									<li class="nav-item"><a class="nav-link" href="<?php echo(base_url());?>tracking.php">Tracking</a></li>
									<li class="nav-item"><a class="nav-link" href="<?php echo(base_url());?>elements.php">Elements</a></li>
								</ul>
							</li>
			...
			<div class="row">
				<div class="col-lg">
					<div class="login_form_inner">
						...
						<?php echo form_open("Accueil/adminconnect");?>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="<?php echo(base_url());?>https://colorlib.com" target="_blank">Colorlib</a>
